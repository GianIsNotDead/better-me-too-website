      ...
      <div className="container">
        ...
        <main className="bmt-main">
          <section className="bmt-about-text">
            <p className="bmt-text-normal">We want to explore ways to improve the relationship between human mind and body. We start by investigating brain stimulation and observation (e.g. TMS, tRNS, EEG). Then study concepts such as sensory substitution and subconscious learning.</p>
